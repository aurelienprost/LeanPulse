 ...
 * a generation profile that outputs root documents to "out2" in the current
 * directory, and children to the "pdf" sub-directory, relative to the parent.
 * 
 ...
 */
public class TestGenMatlabArchiRelToParent extends AbsTestGenerator {

	/**
	 * Sets the test cases to test the architecture generation with root output
	 * relative to the current directory and children output relative to the
	 * parent.
	 * 
    ...
    public static Collection<Object[]> parameters() {
    	...
    	GenProfileRenderConfImpl archSubConf = new GenProfileRenderConfImpl("template", "pdf", new File("pdf"), GenProfileRenderConf.RELTO_PARENT,
    			matVerSuffix, new PdfSecurityOptions(), GenProfileRenderConf.ACTION_NOP, GenProfileRenderConf.GENDEP_SEPDOCS, params);
    	GenProfileRenderConf archConf = new GenProfileRenderConfImpl("template", "pdf", new File("../#out2"), GenProfileRenderConf.RELTO_CURDIR,
    			matVerSuffix, new PdfSecurityOptions(), GenProfileRenderConf.ACTION_NOP, GenProfileRenderConf.GENDEP_SEPDOCS, params,
    			new GenProfileRenderConfImpl[] {archSubConf});
    	GenProfile profile = new GenProfileImpl("archparent", "ArchiRelToParent", "", "", new GenProfileSnapConfImpl(), new GenProfileRenderConf[] {archConf});
	 ...
	 */
	public TestGenMatlabArchiRelToParent(File mdlFile, GenProfile profile, boolean showUI) {
