 ...
 * a generation profile that outputs documents to "out1" in the current
 * directory.
 * 
 ...
 */
public class TestGenMatlabArchiRelToCurDir extends AbsTestGenerator {
    ...
    public static Collection<Object[]> parameters() {
    	...
    	GenProfileRenderConf archConf = new GenProfileRenderConfImpl("template", "pdf", new File("../#out1"), GenProfileRenderConf.RELTO_CURDIR,
    			matVerSuffix, new PdfSecurityOptions(), GenProfileRenderConf.ACTION_NOP, GenProfileRenderConf.GENDEP_SEPDOCS, params);
    	GenProfile profile = new GenProfileImpl("archcurdir", "ArchiRelToCurDir", "", "", new GenProfileSnapConfImpl(), new GenProfileRenderConf[] {archConf});
	 ...
	 */
	public TestGenMatlabArchiRelToCurDir(File mdlFile, GenProfile profile, boolean showUI) {
